...
export function LeaderboardContent() {
    ...
    const containerStyle = connected
        ? undefined
        : {
    ...
    return (
        <div className="flex min-h-0 flex-col overflow-hidden" style={containerStyle}>
            <div
                className={cn(
                    "max-w-6xl mx-auto w-full px-4 sm:px-6 py-6 sm:py-10",
                    connected ? "" : "flex-1 overflow-y-auto"
                )}
            >
                ...
                {isInitialLoading ? (
                    ...
                    <div className="flex shrink-0 items-end justify-center gap-4 md:gap-8 mb-6 sm:mb-8 pt-4">
                        <Link href={`/profile/${entries[1].wallet}`} className="flex flex-col items-center hover:opacity-90 transition-opacity">
                            ...
                            <p className="font-game text-lg mt-2 truncate max-w-[140px] text-center">
                                {truncateWallet(entries[1].wallet)}
                            </p>
                            <p className="font-game text-lg sm:text-xl text-muted-foreground">
                            ...
                            <div className="w-28 md:w-36 h-20 bg-gradient-to-t from-muted to-muted/60 border-4 border-muted-foreground/30 rounded-t-xl flex items-center justify-center mt-2">
                                <div className="flex flex-col items-center gap-0.5">
                                    ...
                                    <span className="font-game text-xl text-muted-foreground">#2</span>
                                </div>
                            </div>
                        </Link>

                        <Link href={`/profile/${entries[0].wallet}`} className="flex flex-col items-center -mt-4 hover:opacity-90 transition-opacity">
                            <PixelAvatar wallet={entries[0].wallet} size="lg" />
                            <p className="font-game text-lg mt-2 truncate max-w-[150px] text-center">
                                {truncateWallet(entries[0].wallet)}
                            </p>
                            <p className="font-game text-lg sm:text-xl text-yellow-400">
                            ...
                            <div className="w-32 md:w-40 h-28 bg-gradient-to-t from-yellow-400/20 to-yellow-400/5 border-4 border-yellow-400 rounded-t-xl flex items-center justify-center mt-2 shadow-[0_0_30px_rgba(250,204,21,0.15)]">
                                <div className="flex flex-col items-center gap-0.5">
                                    ...
                                    <span className="font-game text-2xl text-yellow-400">#1</span>
                                </div>
                            </div>
                        </Link>
                        ...
                        <Link href={`/profile/${entries[2].wallet}`} className="flex flex-col items-center hover:opacity-90 transition-opacity">
                            ...
                            <p className="font-game text-lg sm:text-xl text-orange-400">
                            ...
                            <div className="w-28 md:w-36 h-16 bg-gradient-to-t from-orange-400/20 to-orange-400/5 border-4 border-orange-400/50 rounded-t-xl flex items-center justify-center mt-2">
                                <div className="flex flex-col items-center gap-0.5">
                                    <span className="text-lg leading-none" aria-hidden>🥉</span>
                                    <span className="font-game text-xl text-orange-400">#3</span>
                                </div>
                            </div>
                        </Link>
                    </div>
